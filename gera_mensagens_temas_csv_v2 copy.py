...
def get_hierarchical_topic(message_text, topic_keywords_hierarchical): # Função para classificação hierárquica
    ...
    return 'Outros', None  # Retorna 'Outros' para tópico principal e None para subtema se não houver correspondência
